...
class WHUSarSarPipeline(EvalPipeline):
    default_conf = {
        "data": {
            "batch_size": 1,
            "name": "homography_dataset",
            "data_dir": "InvModal/WHU-OPT-SAR/WHU_homography/sar_sar",
            "num_workers": 16,
            "preprocessing": {
                "resize": 540,
                "side": "short",
...
if __name__ == "__main__":
    ...
    default_conf = OmegaConf.create(WHUSarSarPipeline.default_conf)
    ...
    pipeline = WHUSarSarPipeline(conf)
    s, f, r = pipeline.run(
