...
class GoogleEarthPipeline(EvalPipeline):
    default_conf = {
        "data": {
            "batch_size": 1,
            "name": "homography_dataset",
            "data_dir": "InvModal/GoogleEarth/GoogleEarth_homography",
            "num_workers": 16,
            "preprocessing": {
...
if __name__ == "__main__":
    ...
    default_conf = OmegaConf.create(GoogleEarthPipeline.default_conf)
    ...
    pipeline = GoogleEarthPipeline(conf)
    s, f, r = pipeline.run(
        experiment_dir, overwrite=args.overwrite, overwrite_eval=args.overwrite_eval,config=conf
    )
