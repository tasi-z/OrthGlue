...
class WHUNirsNirsPipeline(EvalPipeline):
    default_conf = {
        "data": {
            "batch_size": 1,
            "name": "homography_dataset",
            "data_dir": "InvModal/WHU-OPT-SAR/WHU_homography/nirs_nirs",
            "num_workers": 16,
            "preprocessing": {
                "resize": 540,
                "side": "short",
...
if __name__ == "__main__":
    ...
    default_conf = OmegaConf.create(WHUNirsNirsPipeline.default_conf)
    ...
    pipeline = WHUNirsNirsPipeline(conf)
    s, f, r = pipeline.run(
